 ...
 * No se pueden comprar más productos hasta que este depósito esté vacío.
 * @see JPanel
 */
public class Panel_Recoleccion_Productos extends JPanel {
    /**
     * Si hay producto en bandeja el hacer clic en el panel hará que el comprador reciba el producto.
     */
